...
- Correlation analysis: NAAT coverage vs detection rate (R² = 0.47); HCW density vs detection rate (R² = 0.51)
...
| TB detection rate (2023) | ~92% (up from 56% in 2015) |
| COVID impact on TB notifications (2020) | −38% in one year |
| NAAT coverage vs detection rate (R²) | 0.47 |
| HCW density vs detection rate (R²) | 0.51 |
